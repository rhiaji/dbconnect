...
function Calendar({ className, classNames, showOutsideDays = true, components: userComponents, ...props }) {
	const defaultClassNames = {
		...
		month: 'w-full',
		month_caption: 'relative mx-10 mb-1 flex h-12 items-center justify-center z-20',
	...
	const mergedClassNames = Object.keys(defaultClassNames).reduce((acc, key) => {
		return {
			...acc,
			[key]: classNames && classNames[key] ? cn(defaultClassNames[key], classNames[key]) : defaultClassNames[key],
		}
	}, {})
